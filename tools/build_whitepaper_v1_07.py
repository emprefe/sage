...
def build():
    ...
    story = [
        ...
        Spacer(1, 0.35 * inch),
        p("Status: design revision with a v0.02 Core draft. The repository implementation remains the authoritative record of what is currently implemented. The v0.01 wire format is retained as legacy input.", note),
        Spacer(1, 0.5 * inch),
        ...
        p("The repository currently contains a Python-first v0.02 participant-handshake implementation with Core parsing, explicit v0.01 legacy parsing, PNG metadata transport, an experimental concealed PNG profile, CLI commands, conformance vectors, transformation fixtures, and CI.", body),
        ...
        table([
            ...
            [p("B. Python oracle", cell), p("Harden the v0.02 Core, profiles, CLI, vectors, and tests; retain explicit v0.01 compatibility behavior.", cell)],
